      ...
      <main className="page-wrapper">
              ...
              <div className="col-lg-6">
                <div className="inner text-start">
                  ...
                  <p className="description">
                    I am an outstanding Product Designer from Lagos, Fatima. You will find me smiling almost every time
                    while designing thoughtful products, and experiences that people love and businesses value.
                  </p>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-12 mb--10">
                <SectionTitleTwo Title="My Recent Works." textAlign="text-start" />
              </div>
            </div>
          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-12 mb--40">
                <SectionTitleTwo Title="My Pricing Plan." textAlign="text-start" />
              </div>
            </div>
            <PricingOne />
          </div>
        ...
        <div className="rwt-testimonial-area rn-section-gapBottom">
          <div className="container">
            <div className="row mb--20">
              <div className="col-lg-12">
                <SectionTitleTwo Title="My Clients Review." textAlign="text-start" />
              </div>
            </div>
            <TestimonialOne
        ...
        <div className="contact-area rn-section-gapBottom">
          <div className="container">
            <div className="row mb--20">
              <div className="col-lg-12">
                <SectionTitleTwo Title="Contact With Me." textAlign="text-start" />
              </div>
            </div>
