...
const Plovdiv = () => {
  const { data, error, isLoading } = useSWR(`${process.env.REACT_APP_API_URL}/api/get-regional-committee?city=Plovdiv`, fetcher);
    ...
    <>
      ...
      <main className="page-wrapper">
        ...
        <div
          ...
          style={{ backgroundImage: `url(/images/banner/plovdiv.jpg)` }}
        >
                        ...
                        <TabPanel>
                          <div className="rn-tab-content">
                            <div className="inner">
                              ...
                              <a
                                style={{ color: "blue" }}
                                href="https://www.ciab-plovdiv.info"
                                target="_blank"
