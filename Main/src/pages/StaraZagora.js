...
const StaraZagora = () => {
  const { data, error, isLoading } = useSWR(`${process.env.REACT_APP_API_URL}/api/get-regional-committee?city=Zagora`, fetcher);
    ...
    <>
      ...
      <main className="page-wrapper">
        ...
        <div
          ...
          style={{ backgroundImage: `url(/images/banner/stara-zagora.jpg)` }}
        >
