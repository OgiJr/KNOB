...
const Ruse = () => {
  const { data } = useSWR(`${process.env.REACT_APP_API_URL}/api/get-regional-committee?city=Ruse`, fetcher);
    ...
    <>
      ...
      <main className="page-wrapper">
        ...
        <div
          ...
          style={{ backgroundImage: `url(/images/banner/ruse.jpg)`, height: 300 }}
        >
