...
const Ruse = () => {
  const { data, error, isLoading } = useSWR(`${process.env.REACT_APP_API_URL}/api/get-regional-committee?city=Ruse`, fetcher);
    ...
    <>
      ...
      <main className="page-wrapper">
        ...
        <div
          ...
          style={{ backgroundImage: `url(/images/banner/ruse.jpg)` }}
        >
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="inner pt--80 text-center">
                  ...
                  <h1 className="title display-one mt-10">Русе</h1>
                </div>
              </div>
            </div>
          </div>
              ...
              <Tabs>
                <div className="row row--30 align-items-center">
                  <div className="col-lg-5 hidden-phone">
                    <img className="radius-small" src="./images/bar/ruse.jpg" alt="about" />
                  </div>
