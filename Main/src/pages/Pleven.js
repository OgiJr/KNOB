...
const Pleven = () => {
  const { data } = useSWR(`${process.env.REACT_APP_API_URL}/api/get-regional-committee?city=Pleven`, fetcher);
    ...
    <>
      ...
      <main className="page-wrapper">
        ...
        <div
          ...
          style={{ backgroundImage: `url(/images/banner/pleven.jpg)`, height: 300 }}
        >
