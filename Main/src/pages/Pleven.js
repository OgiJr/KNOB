  ...
  return (
    <>
      ...
      <main className="page-wrapper">
        ...
        {/* Start Slider Area  */}
        <div className="slider-area slider-style-1 height-850 bg_image" data-black-overlay="7" style={{ backgroundImage: `url(${process.env.PUBLIC_URL}/images/banner/pleven.jpg)` }}>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="inner pt--80 text-center">
                  ...
                  <h1 className="title display-one mt-10">Плевен, Ловеч</h1>
                </div>
              </div>
            </div>
          </div>
              ...
              <Tabs>
                <div className="row row--30 align-items-center">
                  <div className="col-lg-5 hidden-phone">
                    <img className="radius-small" src="./images/bar/pleven.jpg" alt="about" />
                  </div>
                      ...
                      <div className="tab-content-panel">
                        <TabPanel>
                          <div className="rn-tab-content">
                            <div className="inner">IBAN: BG50 BPBI 7942 1079 5016 13</div>
                          </div>
                        </TabPanel>
                      </div>
                    </div>
