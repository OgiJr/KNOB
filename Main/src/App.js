...
import HelpfulLinks from "./elements/portfolio/HelpfulLinks";
    ...
    <Router>
      <PageScrollTop>
        <Switch>
          ...
          />
          <Route
            path={`${process.env.PUBLIC_URL + "/helpful-links"}`}
            exact
          ...
          />
          <Route
            path={`${process.env.PUBLIC_URL + "/blog-quiz"}`}
            exact
            component={BlogQuiz}
          />
          <Route
            path={`${process.env.PUBLIC_URL + "/blog-archive"}`}
            exact
